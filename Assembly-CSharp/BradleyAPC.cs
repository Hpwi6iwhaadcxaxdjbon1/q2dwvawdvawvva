...
public class BradleyAPC : BaseCombatEntity, TriggerHurtNotChild.IHurtTriggerUser
{
	...
	// Token: 0x0600087B RID: 2171 RVA: 0x00051CCC File Offset: 0x0004FECC
	...
	// Token: 0x0600087D RID: 2173 RVA: 0x00051D26 File Offset: 0x0004FF26
	...
	// Token: 0x0600087E RID: 2174 RVA: 0x00051D3A File Offset: 0x0004FF3A
	public bool IndexValid(int index)
	{
		return this.HasPath() && index >= 0 && index < this.currentPath.Count;
	}

	// Token: 0x0600087F RID: 2175 RVA: 0x00051D5A File Offset: 0x0004FF5A
	...
	// Token: 0x06000880 RID: 2176 RVA: 0x00051D76 File Offset: 0x0004FF76
	...
	// Token: 0x06000881 RID: 2177 RVA: 0x00051D9D File Offset: 0x0004FF9D
	public bool PathComplete()
	{
		return !this.HasPath() || (this.currentPathIndex == this.currentPath.Count - 1 && this.AtCurrentPathNode());
	}

	// Token: 0x06000882 RID: 2178 RVA: 0x00051DC8 File Offset: 0x0004FFC8
	...
	// Token: 0x06000883 RID: 2179 RVA: 0x00051E20 File Offset: 0x00050020
	...
	// Token: 0x06000884 RID: 2180 RVA: 0x00051EA0 File Offset: 0x000500A0
	...
	// Token: 0x06000885 RID: 2181 RVA: 0x00051F4C File Offset: 0x0005014C
	...
	// Token: 0x06000886 RID: 2182 RVA: 0x00051FC8 File Offset: 0x000501C8
	public void AdvancePathMovement(bool force)
	{
		...
		vector += global::BradleyAPC.Direction2D(vector2, vector) * Mathf.Min(a, num * 20f);
		this.SetDestination(vector);
	}

	// Token: 0x06000887 RID: 2183 RVA: 0x00052084 File Offset: 0x00050284
	...
	// Token: 0x06000888 RID: 2184 RVA: 0x00052138 File Offset: 0x00050338
	...
	// Token: 0x06000889 RID: 2185 RVA: 0x000521B8 File Offset: 0x000503B8
	...
	// Token: 0x0600088A RID: 2186 RVA: 0x00052270 File Offset: 0x00050470
	...
	// Token: 0x0600088B RID: 2187 RVA: 0x00052488 File Offset: 0x00050688
	...
	// Token: 0x0600088C RID: 2188 RVA: 0x000524AC File Offset: 0x000506AC
	...
	// Token: 0x0600088D RID: 2189 RVA: 0x000524DC File Offset: 0x000506DC
	...
	// Token: 0x0600088E RID: 2190 RVA: 0x00052638 File Offset: 0x00050838
	...
	// Token: 0x0600088F RID: 2191 RVA: 0x000526BC File Offset: 0x000508BC
	...
	// Token: 0x06000890 RID: 2192 RVA: 0x000527E4 File Offset: 0x000509E4
	...
	// Token: 0x06000891 RID: 2193 RVA: 0x00052970 File Offset: 0x00050B70
	...
	// Token: 0x06000892 RID: 2194 RVA: 0x00052AA4 File Offset: 0x00050CA4
	...
	// Token: 0x06000893 RID: 2195 RVA: 0x00052B18 File Offset: 0x00050D18
	...
	// Token: 0x06000894 RID: 2196 RVA: 0x00052C1C File Offset: 0x00050E1C
	...
	// Token: 0x06000895 RID: 2197 RVA: 0x00052D34 File Offset: 0x00050F34
	...
	// Token: 0x06000896 RID: 2198 RVA: 0x00052DCC File Offset: 0x00050FCC
	...
	// Token: 0x06000897 RID: 2199 RVA: 0x00052E68 File Offset: 0x00051068
	public static global::BradleyAPC SpawnRoadDrivingBradley(Vector3 spawnPos, Quaternion spawnRot)
	{
		...
		foreach (PathList pathList2 in TerrainMeta.Path.Roads)
		{
			...
			foreach (Vector3 a in pathList2.Path.Points)
			{
	...
	// Token: 0x06000898 RID: 2200 RVA: 0x00053178 File Offset: 0x00051378
	...
	// Token: 0x06000899 RID: 2201 RVA: 0x0005319E File Offset: 0x0005139E
	public void SetDestination(Vector3 dest)
	{
		this.destination = dest;
	}

	// Token: 0x0600089A RID: 2202 RVA: 0x000531A8 File Offset: 0x000513A8
	public override void ServerInit()
	{
		...
		this.obstacleHitMask = LayerMask.GetMask(new string[]
		{
			"Vehicle World"
		});
	...
	// Token: 0x0600089B RID: 2203 RVA: 0x000063A5 File Offset: 0x000045A5
	public override void OnCollision(Collision collision, global::BaseEntity hitEntity)
	{
	}

	// Token: 0x0600089C RID: 2204 RVA: 0x00053237 File Offset: 0x00051437
	...
	// Token: 0x0600089D RID: 2205 RVA: 0x00053274 File Offset: 0x00051474
	...
	// Token: 0x0600089E RID: 2206 RVA: 0x00053304 File Offset: 0x00051504
	...
	// (get) Token: 0x0600089F RID: 2207 RVA: 0x0002BF84 File Offset: 0x0002A184
	...
	// Token: 0x060008A0 RID: 2208 RVA: 0x0005334A File Offset: 0x0005154A
	public bool IsAtDestination()
	{
		return Vector3Ex.Distance2D(base.transform.position, this.destination) <= this.stoppingDist;
	}

	// Token: 0x060008A1 RID: 2209 RVA: 0x0005336D File Offset: 0x0005156D
	...
	// Token: 0x060008A2 RID: 2210 RVA: 0x00053390 File Offset: 0x00051590
	...
	// Token: 0x060008A3 RID: 2211 RVA: 0x000533E4 File Offset: 0x000515E4
	...
	// Token: 0x060008A4 RID: 2212 RVA: 0x00053556 File Offset: 0x00051756
	...
	// Token: 0x060008A5 RID: 2213 RVA: 0x00053574 File Offset: 0x00051774
	...
	// Token: 0x060008A6 RID: 2214 RVA: 0x00053738 File Offset: 0x00051938
	public void UpdateMovement_Hunt()
	{
		...
		if (targetInfo.IsValid())
		{
			...
			{
				bool flag = false;
				IAIPathNode start = this.patrolPath.GetClosestToPoint(base.transform.position);
				List<IAIPathNode> list = Facepunch.Pool.GetList<IAIPathNode>();
				if (this.GetEngagementPath(ref list))
				{
					flag = true;
				...
				foreach (IAIPathNode iaipathNode2 in list2)
				{
					Stack<IAIPathNode> stack2 = new Stack<IAIPathNode>();
					float num2;
					if (targetInfo.entity.IsVisible(iaipathNode2.Position + new Vector3(0f, y, 0f), float.PositiveInfinity) && AStarPath.FindPath(start, iaipathNode2, out stack2, out num2) && num2 < num)
					{
						stack = stack2;
						num = num2;
						iaipathNode = iaipathNode2;
				...
				if (stack == null && list2.Count > 0)
				{
					...
					IAIPathNode iaipathNode3 = list2[UnityEngine.Random.Range(0, list2.Count)];
					float num3;
					if (AStarPath.FindPath(start, iaipathNode3, out stack3, out num3) && num3 < num)
					{
						stack = stack3;
						iaipathNode = iaipathNode3;
					}
				}
				if (stack != null)
				{
					...
					foreach (IAIPathNode iaipathNode4 in stack)
					{
						this.currentPath.Add(iaipathNode4.Position);
					}
					this.currentPathIndex = -1;
					this.pathLooping = false;
					this.finalDestination = iaipathNode.Position;
				}
	...
	// Token: 0x060008A7 RID: 2215 RVA: 0x00053A00 File Offset: 0x00051C00
	public void DoSimpleAI()
	{
		...
		if (num > this.stoppingDist)
		{
			...
			this.AvoidObstacles(ref num5);
			float num6 = Vector3.Dot(this.myRigidBody.velocity, base.transform.forward);
			if (this.throttle <= 0f || num6 >= 0.5f)
			{
				this.timeSinceSeemingStuck = 0f;
			}
			...
			{
				this.throttle = (0.1f + Mathf.InverseLerp(0f, 20f, value) * 1f) * num5 + num7;
			}
		}
		this.DoWeaponAiming();
	...
	// Token: 0x060008A8 RID: 2216 RVA: 0x00053CB1 File Offset: 0x00051EB1
	...
	// Token: 0x060008A9 RID: 2217 RVA: 0x00053CCC File Offset: 0x00051ECC
	...
	// Token: 0x060008AA RID: 2218 RVA: 0x00053EAC File Offset: 0x000520AC
	...
	// Token: 0x060008AB RID: 2219 RVA: 0x0005422C File Offset: 0x0005242C
	...
	// Token: 0x060008AC RID: 2220 RVA: 0x00054240 File Offset: 0x00052440
	...
	// Token: 0x060008AD RID: 2221 RVA: 0x00054290 File Offset: 0x00052490
	...
	// Token: 0x060008AE RID: 2222 RVA: 0x00054308 File Offset: 0x00052508
	...
	// Token: 0x060008AF RID: 2223 RVA: 0x000543D8 File Offset: 0x000525D8
	...
	// Token: 0x060008B0 RID: 2224 RVA: 0x00054415 File Offset: 0x00052615
	...
	// Token: 0x060008B1 RID: 2225 RVA: 0x00054454 File Offset: 0x00052654
	...
	// Token: 0x060008B2 RID: 2226 RVA: 0x0005483C File Offset: 0x00052A3C
	...
	// Token: 0x060008B3 RID: 2227 RVA: 0x00054880 File Offset: 0x00052A80
	...
	// Token: 0x060008B4 RID: 2228 RVA: 0x000548D8 File Offset: 0x00052AD8
	...
	// Token: 0x060008B5 RID: 2229 RVA: 0x0002CDA7 File Offset: 0x0002AFA7
	public global::BasePlayer GetPlayerDamageInitiator()
	{
		return null;
	}

	// Token: 0x060008B6 RID: 2230 RVA: 0x00054924 File Offset: 0x00052B24
	...
	// Token: 0x060008B7 RID: 2231 RVA: 0x000063A5 File Offset: 0x000045A5
	...
	public class TargetInfo : Facepunch.Pool.IPooled
	{
		...
		// Token: 0x06004D76 RID: 19830 RVA: 0x001A0D69 File Offset: 0x0019EF69
		...
		// Token: 0x06004D77 RID: 19831 RVA: 0x001A0D88 File Offset: 0x0019EF88
		...
		// Token: 0x06004D78 RID: 19832 RVA: 0x000063A5 File Offset: 0x000045A5
		public void LeavePool()
		{
		}

		// Token: 0x06004D79 RID: 19833 RVA: 0x001A0D98 File Offset: 0x0019EF98
		...
		// Token: 0x06004D7A RID: 19834 RVA: 0x001A0E7F File Offset: 0x0019F07F
		public bool IsVisible()
		{
			return this.lastSeenTime != -1f && UnityEngine.Time.time - this.lastSeenTime < global::BradleyAPC.sightUpdateRate * 2f;
		}

		// Token: 0x06004D7B RID: 19835 RVA: 0x001A0EA9 File Offset: 0x0019F0A9
		public bool IsValid()
		{
